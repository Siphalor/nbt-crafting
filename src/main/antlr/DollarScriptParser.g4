...
lambda
  ...
  | LPAREN RPAREN ARROW LPAREN body=statementList RPAREN
  | identifier ARROW LPAREN body=statementList RPAREN
  | LPAREN identifier (COMMA identifier)* RPAREN ARROW LPAREN body=statementList RPAREN
  ;
functionCall

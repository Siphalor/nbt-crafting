...
[![latest maven release](https://img.shields.io/maven-metadata/v?label=latest%20maven%20release&metadataUrl=https%3A%2F%2Fmaven.siphalor.de%2Fde%2Fsiphalor%2Fnbtcrafting-1.19%2Fmaven-metadata.xml)](https://maven.siphalor.de/de/siphalor/nbtcrafting-1.19/)
...
You can find a datapack with some examples here: [Example Datapack](https://nightly.link/Siphalor/nbt-crafting/workflows/build-example-datapack.yaml/1.19-2.0/example-datapack.zip)
